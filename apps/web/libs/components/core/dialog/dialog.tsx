...
const DialogHeader = ({
  ...
  <div
    className={mergeClasses("flex flex-col space-y-2 sm:text-left", className)}
    {...props}
  />
);
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={mergeClasses(
      "text-lg font-[family-name:var(--font-avenir-medium)] font-semibold leading-none tracking-tight",
      className,
    )}
    {...props}
  />
