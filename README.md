...
- `@shettayyy/eslint-config`: `eslint` configurations (includes `eslint-config-next` and `eslint-config-prettier`)
- `@shettayyy/typescript-config`: `tsconfig.json`s used throughout the monorepo
